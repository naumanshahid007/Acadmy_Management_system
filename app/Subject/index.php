...
<div class="box-body well" style="border-top:1px solid #3c8dbc;">
      ...
      <a href="create_subject.php" class="btn btn-success btn-xs" style="font-size: 15px; border-radius: 10px;"><i class="glyphicon glyphicon-plus-sign"></i> Create Subject</a><hr>
    ...
    <table id="example1" class="table table-bordered table-striped">
               ...
               //Query to show subject 
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  //Query to dispaly class name to related subject
                  ...
                  <tr>
                    ...
                    <td><a href="update_subject.php?subject_id=<?php echo $row['subject_id'];?>" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
                      <a href="delete_subject.php?subject_id=<?php echo $row['subject_id'];?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to delete this this');"><i class="glyphicon glyphicon-trash"></i> Delete</a></td>
                  </tr>
                  <?php
