...
(2, 'First Year ', '', 1, 1, 0, '2019-01-16 11:51:58', '0000-00-00 00:00:00'),
(3, 'Second Year', 'Fsc or other class', 1, 1, 0, '2019-01-16 11:52:47', '0000-00-00 00:00:00');
...
INSERT INTO `groups` (`group_id`, `class_id`, `group_name`, `group_type`, `group_description`, `group_status`, `delete_status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(5, 1, 'Fsc 1 Medical', 'Evening', '2', 'Active', 1, 1, 0, '2019-01-18 10:39:46', '0000-00-00 00:00:00'),
(6, 3, 'BScs', 'Evening', 'Nothing to show here ', 'Active', 1, 2, 0, '2019-01-18 11:21:26', '0000-00-00 00:00:00');
...
(1, 'Dexdevs', 'GUlshin iqbal Rahim yar khan', 'GUlshin iqbal Rahim yar khan', 'uploads/5a7b3ba99d47d46e5caab794a6b17729--tulips-flowers-photo-effects.jpg', '311200455631', 1, '2019-01-17 10:00:01', '0000-00-00 00:00:00', 0, 0);
...
(1, 2, 'Physics', 1000, 'Nothing\"', 1, 2, 1, '2019-01-17 11:47:38', '0000-00-00 00:00:00'),
(2, 3, 'Physics', 1000, 'Something to show here', 1, 1, 1, '2019-01-17 11:48:01', '0000-00-00 00:00:00'),
(3, 3, 'C++', 500, 'Nothing to show here', 1, 1, 0, '2019-01-16 18:23:45', '0000-00-00 00:00:00');
...
ALTER TABLE `assign_teacher`
  ...
  ADD CONSTRAINT `assign_teacher_ibfk_4` FOREIGN KEY (`group_id`) REFERENCES `groups` (`group_id`);
